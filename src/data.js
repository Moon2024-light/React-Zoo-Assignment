...
function Animal(name, lifespan, group, food, description, length, weight, habitat, image) {
    this.name = name;
...
let mammals = [
    ...
    new Animal(
        ...
        10,
        "Tasmania",
        getImageURL("tasmanian_devil.jpg")
    ),
    new Animal(
        "Quokka",
        10,
...
let reptiles = [
    ...
    new Animal(
        ...
        getImageURL("hawksbill_turtle.jpg")
    ),
    new Animal(
        "Perentie",
        20,
...
let birds = [
    ...
    new Animal(
        ...
        900 / 1000,
        "SE Australia",
        getImageURL("yellowtailedblackcockatoo.jpg")
    )
]
